        ...
        FastAutoGenerator.create(url,"rjbf4","123456")
                ...
                .globalConfig(builder -> {
                    builder.author("B.M") // 设置作者
                            ...
                            .outputDir("F:\\综合实训\\mooc-sc\\dept-8002\\src\\main\\java");// 指定输出目录
                })
                /*包配置*/
                .packageConfig(builder -> {
                    builder.parent("com") // 设置父包名
                            ...
                            .entity("model")    //实体类包名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml,"F:\\综合实训\\mooc-sc\\dept-8002\\src\\main\\resources\\mapper"));
                })
                //  .templateEngine(new FreemarkerTemplateEngine()) 使用Freemarker引擎模板，默认的是Velocity引擎模板
                /*策略配置*/
                .strategyConfig(builder -> {
                    builder.addInclude("m_learn_progress") // 设置需要生成的表名
