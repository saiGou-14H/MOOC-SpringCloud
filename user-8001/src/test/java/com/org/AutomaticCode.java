        ...
        FastAutoGenerator.create(url,"rjbf4","123456")
                ...
                .globalConfig(builder -> {
                    builder.author("B.M") // 设置作者
                            ...
                            .outputDir("D:\\JAVA\\IDEA工作区\\mooc-sc\\user-8001\\src\\main\\java");// 指定输出目录
                })
                /*包配置*/
                .packageConfig(builder -> {
                    builder.parent("com") // 设置父包名
                            ...
                            .entity("model")    //实体类包名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml,"D:\\JAVA\\IDEA工作区\\mooc-sc\\user-8001\\src\\main\\resources\\mapper"));
                })
