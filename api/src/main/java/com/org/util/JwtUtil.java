...
public class JwtUtil {
     ...
     */
    public static String createToken(Long id, String userName, Integer role) {
        //过期时间
        ...
        String token = JWT.create()
                ...
                .withClaim("username", userName)   //email
                .withClaim("role", role)//password
...
//            logger.error("token解码异常");
    ...
    public static Long getId(HttpServletRequest request) {
        ...
        return Long.parseLong(String.valueOf(userData.get("id"))) ;
    }
    ...
    public static String getRole(HttpServletRequest request) {
        String token = request.getHeader("Authorization").replaceFirst("bearer ", "");
        Map<String, Claim> userData = JwtUtil.verifyToken(token);         //解析token
        return userData.get("role").asString();
    }
